...
\end{align*}
 ...
 Each unblocked cell was discovered at least once so th

and the total number of moves is bounded above by the maximum number of cells multiplied by number of searches which is less than number of unblocked cells multiply by number of searches. Therefore it is bounded above by the number of unblocked cells squared.
